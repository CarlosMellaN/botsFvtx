...
function errorEmail(messageErrorEmail) {
    ...
    var mailOptions = {
        ...
        subject: 'Problemas con el bot de Sodimac',
...
let checkError = 0
const scraperObject = {
    url: 'https://b2b.sodimac.com/b2bsoclpr/grafica/html/index.html',
    ...
    async scraper(browser){
        ...
        try {
            ...
            await frame.select('select[name=CADENA]', '6');
            await frame.type('#empresa', process.env.EMPRESA_SODIMAC, {delay: 100})
            await frame.type('#usuario', process.env.USER_SODIMAC, {delay: 200})
            await frame.type('#clave', process.env.PASS_SODIMAC, {delay: 200})
            ...
            await frame.$eval('#Bar5', el => el.click())
